...
### Project Structure
```
├── Adewalemgsapplication.xcodeproj  - it lets you create and modify Xcode projects from Ruby.      
│ 
├── Adewalemgsapplication            - Application components folder
